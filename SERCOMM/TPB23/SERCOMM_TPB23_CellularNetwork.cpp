...
SERCOMM_TPB23_CellularNetwork::SERCOMM_TPB23_CellularNetwork(ATHandler &atHandler) : AT_CellularNetwork(atHandler)
{
    _op_act = RAT_NB1;
}

SERCOMM_TPB23_CellularNetwork::~SERCOMM_TPB23_CellularNetwork()
{
}
